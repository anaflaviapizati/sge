...
export default function Register() {
    ...
    return (
        <div className="min-vh-100 d-flex align-items-center justify-content-center"
             style={{ backgroundImage: "url('/images/background.png')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-6 col-lg-4">
                        <div className="card shadow" style={{ minHeight: 350, maxHeight: 500, background: 'rgba(255,255,255,0.95)' }}>
                            <div className="card-body p-4">
                                <div className="text-center mb-3">
                                    <div className="d-flex flex-column align-items-center">
                                        <span className="fs-1 fw-bold mb-2">SGE</span>
                                        <span className="text-muted">Crie sua conta</span>
                                        <div style={{ width: 100, height: 3, background: '#dc3545', marginTop: 8, borderRadius: 2 }}></div>
                                    </div>
                                </div>
