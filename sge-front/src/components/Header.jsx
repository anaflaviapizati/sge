                ...
                <div className="d-flex align-items-center ms-auto">
                    <ul className="navbar-nav flex-row align-items-center">
                        <li className="nav-item mx-2">
                            <Link className={`nav-link position-relative ${isActive('/')}`} to="/">
                                Início
                                <span className="nav-underline"></span>
                            </Link>
                        </li>
                        <li className="nav-item mx-2">
                            <Link className={`nav-link position-relative ${isActive('/alunos')}`} to="/alunos">
                                Meus Contratos
                                <span className="nav-underline"></span>
                            </Link>
                        </li>
                        <li className="nav-item mx-2">
                            <Link className={`nav-link position-relative ${isActive('/empresas')}`} to="/empresas">
                                Ajuda
                                <span className="nav-underline"></span>
                            </Link>
                        </li>
                        <li className="nav-item mx-2">
                            {/* Ícone de usuário vermelho com dropdown */}
                            <div className="dropdown">
                                <button 
                                    className="btn btn-link p-0 user-icon" 
                                    type="button" 
                                ...
                                <ul className="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <h6 className="dropdown-header">Usuário</h6>
                                    </li>
                                    <li>
                                        <button 
...
/* Estilos para o ícone de usuário */
.user-icon {
